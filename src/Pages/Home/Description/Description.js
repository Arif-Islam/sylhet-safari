    ...
    return (
        <div className='bg-emerald-700'>
            <div className='w-11/12 lg:w-4/5 2xl:w-3/4 mx-auto'>
                ...
                <div className="">
                    <button className="ml-2 text-emerald-700 text-lg font-medium mb-14 bg-white px-6 py-2 border-2 border-white rounded-sm hover:text-white hover:bg-emerald-700">Popular Tours</button>
                </div>
            </div>
        </div>
    );
